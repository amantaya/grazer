...
Each row within the example data represents a different pasture, and the columns (e.g., Sample_1, Sample_2) represent the weight of clipped and dried forage (in grams) within the sampling frame at multiple sampling sites within the same pasture.
...
You can also specify the units of the dimensions (e.g., "cm", "m", "in", "ft"). The `calc_plot_area` function will return the area covered by the sampling frame in the original units squared.
