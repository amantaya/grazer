...
Finally, we can calculate the forage production per unit area (e.g., kg/ha, lb/acre) for each pasture using the `calc_forage_prod()` function. This function scales the average sample weight to the desired unit (e.g., kg/ha, lb/acre) based on the area covered by the sampling frame.
